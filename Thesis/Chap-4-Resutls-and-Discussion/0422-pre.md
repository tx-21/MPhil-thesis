...
# Reuslt 1 (Exp-1)
## test and val loss comparison in Jan
...
Table: Model evaluations of each forecasting approach. {#tbl:id}
...
|LSTM|Test loss|LSTM-3[^*]|Test loss|Improvement|
|:---:|:---|:---:|:---|:---:|
|ew3|0.0158\pm0.0004|ew3|0.0149\pm0.0001|5.70%|
|ew2|0.0161\pm0.0000|ew2|0.0150\pm0.0003|6.83%|
|ew4|0.0163\pm0.0003|ew4|0.0152\pm0.0002|6.75%|
|sg5|0.0166\pm0.0001|sg7|0.0155\pm0.0003|13.89%|
|obs|0.0175\pm0.0001|sg5|0.0156\pm0.0001|11.86%|
|or |0.0177\pm0.0002|or |0.0156\pm0.0002|6.02%|
|sg7|0.0180\pm0.0002|sg9|0.0160\pm0.0005|14.89%|
|sg9|0.0188\pm0.0002|obs|0.0164\pm0.0003|6.29%|
...
|LSTM|Test loss|LSTM-3[^5]|Test loss|Improvement|
|:---:|:---|:---:|:---|:---:|
|ew4|0.0136\pm0.0003|sg9|0.0120\pm0.0007|16.08%|
|ew3|0.0138\pm0.0001|ew2|0.0132\pm0.0004|4.35%|
|ew2|0.0138\pm0.0001|ew3|0.0134\pm0.0004|2.90%|
|sg9|0.0143\pm0.0005|ew4|0.0135\pm0.0003|0.74%|
|obs|0.0148\pm0.0003|obs|0.0135\pm0.0001|8.78%|
|sg7|0.0161\pm0.0003|sg7|0.0143\pm0.0003|11.18%|
|sg5|0.0168\pm0.0005|sg5|0.0144\pm0.0002|14.29%|

Table: Evaluation of LSTM trained with positional encoding. {#tbl:id}

[^5]: Number 3 stands for the number of features.

\pagebreak

# Conclusion

|Rank|NH$_{3}$N|NH$_{3}$N + pos[^7]|Colour|Colour + pos|
|:---:|:---:|:---:|:---:|:---:|
|1|**ew3**|**ew3**|**ew4**|sg9    |
|2|**ew2**|**ew2**|**ew3**|**ew2**|
|3|**ew4**|**ew4**|**ew2**|**ew3**|
...
Table: Influence of pre-processing method on NH$_{3}$N and colour forecasting models trained with LSTM. {#tbl:id}

[^7]: Postional encoding.
...
![Ammonia forecasting models trained with different input features. Univariate represents training model with NH$_{3}$N only, and multivariate represents training with both NH$_{3}$N and colour. Pos represents positional encoding, which composed of sine and cosine of hours.](nh3-forecasting-comparison.png){#fig:id width=50%}

![Colour forecasting models trained with different input features. Univariate represents training model with colour only, and multivariate represents training with both NH$_{3}$N and colour. Pos represents positional encoding, which composed of sine and cosine of hours.](colour-forecasting-comparison.png){#fig:id width=50%}