...
\title{Forecasting Ammonia Concentrations and Color Levels using Machine Learning for Reclaimed Water Treatment Operation and Management}  % Title of the thesis.
...
\depthead{Prof.~Limin~ZHANG}    % department head.
...
\input{chapters/chapter-1-intro.tex}
\input{chapters/chapter-2-lit-review.tex}
\input{chapters/chapter-3-methods.tex}
\input{chapters/chapter-4-results.tex}
\input{chapters/chapter-5-conclusion.tex}
...
%                                                                       %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\input{chapters/chapter-6-appendices.tex}
