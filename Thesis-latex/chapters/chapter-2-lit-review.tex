...
Automatic control of chlorine dosage uses online tools for measuring water parameters along with Programmable Logic Controllers (PLCs) \cite{librantz_artificial_2018}. PLC is a system which enables making automatic engineering and chemical decisions for the administration of the type and amount of chemicals required to achieve desirable concentration of free residual chlorine.
