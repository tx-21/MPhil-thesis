...
def scheduled_sampling(model_number, dataloader, EPOCH, lr, k, frequency, path_to_save_model, path_to_save_loss, path_to_save_predictions, device, training_length, current_exp, last_exp_num):
    ...
    for epoch in range(EPOCH + 1):
        ...
        if epoch % 1 == 0: # Plot 1-Step Predictions
            ...
            plot_training_3(epoch, path_to_save_predictions, src_ammonia, sampled_src_ammonia, prediction_ammonia, index_in, index_tar, model_dic_keys_ls[model_number])
