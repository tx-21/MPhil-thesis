...
def main(
    ...
    path_to_save_loss_1 = "loss/save_loss_tf-obs/",
    path_to_save_loss_2 = "loss/save_loss_tf-ew2/",
    path_to_save_loss_3 = "loss/save_loss_tf-sg7/",
    path_to_save_loss_4 = "loss/save_loss_tf-sg7/",
    path_to_save_predictions_1 = "pred/save_predictions_tf-obs/",
    path_to_save_predictions_2 = "pred/save_predictions_tf-ew2/",
    path_to_save_predictions_3 = "pred/save_predictions_tf-sg7/",
    path_to_save_predictions_4 = "pred/save_predictions_tf-sg7/",
    ...
    for m in range(1,3):
        ...
        if database == 1:
            ...
            result_loc = "results/tf-ew2"
            dataset_name = 'tf-ews'
            model_num = 0 # RNN    
        if database == 2:
            root_database = "data/train/obs/"
            result_loc = "results/tf-obs"
            dataset_name = 'tf-obs'
            model_num = 0 # RNN+attn
        if database == 3:
            root_database = "data/train/sg7/"
            result_loc = "results/tf-sg7"
            dataset_name = 'tf-sg7'
            model_num = 0 # DNN    
        if database == 4:
            root_database = "data/train/or/"
            result_loc = "results/tf-or"
            dataset_name = 'tf-or'
            model_num = 0 # RNN+attn       
        ...
        for j in range(Exp_num):
            ...
            # train_loss, best_model = scheduled_sampling(model_num, train_dataloader, epoch, lr, k, frequency, path_to_save_model, path_to_save_loss[model_num], path_to_save_predictions[model_num], device, training_length, current_exp, last_exp_num)
