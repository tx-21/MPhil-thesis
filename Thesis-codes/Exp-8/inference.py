...
def inference(model_number, path_to_save_predictions, forecast_window, dataloader, device, path_to_save_model, best_model,path_to_save_loss,current_exp,last_exp_num):
    ...
    with torch.no_grad():
        ...
        for index_in, index_tar, _input, target, index in dataloader: #iterate all the samples
            ...
            prediction_ammonia = prediction_ammonia[:,0]
        ...
        rmse_1, r2_1 = plot_prediction_horizon(forecast_horizon['fh1'], forecast_horizon['fh1_true'], '1', model_dic_keys_ls[model_number], path_to_save_predictions,date_range,current_exp,last_exp_num,'NH3')
        rmse_2, r2_2 = plot_prediction_horizon(forecast_horizon['fh2'], forecast_horizon['fh2_true'], '2', model_dic_keys_ls[model_number], path_to_save_predictions,date_range,current_exp,last_exp_num,'NH3')
