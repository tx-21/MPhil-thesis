...
def main(
    ...
    for m in range(1,2):
        ...
        for j in range(Exp_num):
            ...
            train_loss, valid_loss, best_model = teacher_forcing(
                model_num, train_dataloader, val_dataloader, forecast_window, epoch,
                lr, k, frequency,
            ...
            _rmse_1, r2_1, _rmse_2, r2_2, _rmse_3, r2_3, inf_loss = inference(
            ...
            status = []
            status = [_rmse_1, r2_1, _rmse_2, r2_2, _rmse_3, r2_3, inf_loss, train_loss, valid_loss, best_model]
