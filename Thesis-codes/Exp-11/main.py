...
if __name__ == "__main__":
    ...
    parser.add_argument("--path_to_save_loss_1",type=str,default="save_loss_Attn-LSTM/")
    parser.add_argument("--path_to_save_loss_2",type=str,default="save_loss_Transformer/")
    ...
    parser.add_argument("--path_to_save_predictions_1",type=str,default="save_predictions_Attn-LSTM/")
    parser.add_argument("--path_to_save_predictions_2",type=str,default="save_predictions_Transformer/")
